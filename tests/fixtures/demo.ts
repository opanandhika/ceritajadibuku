import type { Book, Demo } from "../../src/domain/model";
...
export function newBook(id: string, title = "Buku tanpa judul", example = false): Book {
  return {
    ...
    ] : [{ id: "01", displayName: "[Penulis]", alias: "", placeholder: "[Penulis]", mode: "pending", self: true, knownNames: [], role: "Tokoh saya dalam cerita" }],
    sources: example ? [
...
export function exampleDemo(): Demo {
